...
layui.define(['layer','form','fsConfig','fsButtonCommon'], function (exports) {
  ...
  var fsCommon = {
    ...
    invokeServer : function (funcNo,param,callBackFunc,async,method)
    {
      ...
      invokeWithContentType: function (url,param,callBackFunc,async,method,contentType){
...
//      	 console.error(errorThrown);
    ...
    {
    	var contetType = "application/x-www-form-urlencoded; charset=UTF-8";//"application/json; charset=utf-8"; // application/x-www-form-urlencoded; charset=UTF-8
        fsCommon.invokeWithContentType(url,param,callBackFunc,async,method,contetType);
    },
    //是否需要刷新table,true 需要
